...
interface RestaurantProfile {
  ...
  profileImage?: string; // Add this for the front image
  cuisine: string;
  ...
  <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-6">
        <div className="w-40 h-40 bg-gray-100 rounded-lg overflow-hidden border">
          {imagePreview ? (
            ...
            <Store className="w-12 h-12 text-gray-400 m-auto mt-14" />
          )}
        </div>
        <div className="flex flex-col gap-2">
          ...
          <label
            ...
            className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium cursor-pointer flex items-center gap-2 hover:bg-blue-700"
          >
    ...
    <div className="grid md:grid-cols-2 gap-4 text-gray-600">
      ...
      <Input
        ...
        onChange={(val: string) =>
          setFormData((p: any) => ({ ...p, restaurantName: val }))
        }
    ...
    <Textarea
      ...
      onChange={(val: string) =>
        setFormData((p: any) => ({ ...p, restaurantDescription: val }))
      }
    />
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.restaurant) {
          ...
          setFormData({
            ...data.restaurant,
            deliveryRadius: data.restaurant.deliveryRadius?.toString(),
            minOrder: data.restaurant.minOrder?.toString(),
          });
  ...
  const handleSubmit = async (isCreate = false) => {
    ...
    try {
      ...
      const res = await fetch(
        isCreate ? "/api/create-profile" : "/api/restaurant-profile",
        {
          ...
          {profile && (
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <span
                  className={`px-2 py-0.5 rounded text-[11px] font-bold uppercase ${profile.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <div className="flex items-center gap-3 text-gray-600 text-sm">
                      ...
                      <span className="capitalize">{profile.cuisine}</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 text-sm text-gray-700">
                        <MapPin size={16} className="text-gray-400" /> Delivery
                        Radius: {profile.deliveryRadius} km
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-700">
                        <DollarSign size={16} className="text-gray-400" />{" "}
                        Minimum Order: ${profile.minOrder}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 text-sm text-gray-700 font-medium">
                        <div
                          className={`w-2.5 h-2.5 rounded-full ${profile.isActive ? "bg-green-500" : "bg-red-500"}`}
                        />
